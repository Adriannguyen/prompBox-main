...
async function testLeadershipAPIs() {
  ...
  try {
    ...
    const assignResponse = await fetch(`${API_BASE_URL}/api/pics/${testPic.id}/groups`, {
      method: 'POST',
    ...
    const setLeaderResponse = await fetch(`${API_BASE_URL}/api/pics/${testPic.id}/groups/${testGroup.id}/leader`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    });
    ...
    const removeLeaderResponse = await fetch(`${API_BASE_URL}/api/pics/${testPic.id}/groups/${testGroup.id}/leader`, {
      method: 'DELETE',
    });
